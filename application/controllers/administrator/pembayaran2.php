...
class Pembayaran2 extends CI_Controller {
	...
	public function index() {
		...
		if(!empty($cek)){
			...
			$d['content']= $this->load->view('administrator/pembayaran2/view',$d,true);
	...
	public function view() {
		...
		if(!empty($cek)){
			if(isset($_GET['grid']))
				echo $this->json_model->getJson_bayar_gel_2();
			else
				$this->load->view('administrator/pembayaran2/view');
		}else{
			redirect('/administrator/login/login/');
		}
	}
