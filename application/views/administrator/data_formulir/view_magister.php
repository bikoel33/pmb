...
function Cari_Ijazah(){
	var row = $('#datagrid-crud').datagrid('getSelected');
	var file = row.file_ijazah_magister;
	$("#imagesIjazah").attr('src','<?php echo base_url();?>peserta/ijazah_magister/'+file);
}
...
<tr>
    ...
    <br />
    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_magister" class="easyui-linkbutton" iconCls="icon-reload" plain="true">Refresh</a> | 
...
<table id="datagrid-crud" title="Daftar <?php echo $judul;?>" class="easyui-datagrid" style="width:auto; height: auto;" url="<?php echo site_url('administrator/data_formulir/load_isi_magister'); ?>?grid=true" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" collapsible="true">
	<thead>
		<tr>
		<th field="nik" width="35" sortable="true" align="center">No Daftar</th>
			<th field="NoUjian" width="25" sortable="true" align="center">No Ujian</th>
            ...
            <th field="telp" width="50" sortable="true">No Telpon</th>
            <th field="JK" width="10" sortable="true" align="center">L/P</th>
            <th field="lokasi" width="20" sortable="true">Lokasi</th>
            <th field="prodi" width="20" sortable="true">Prodi</th>
			<th field="waktu" width="20" sortable="true">Waktu</th>
            <th field="RUjian" width="20" sortable="true" align="center">Ruang</th>
			<th field="kelulusan" width="20" sortable="true" align="center">Kelulusan</th>
		</tr>
	</thead>
</table>           
