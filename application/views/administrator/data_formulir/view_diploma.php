...
<tr>
    ...
    <br />
    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_diploma" class="easyui-linkbutton" iconCls="icon-reload" plain="true">Refresh</a> | 
...
<table id="datagrid-crud" title="Daftar <?php echo $judul;?>" class="easyui-datagrid" style="width:auto; height: auto;" url="<?php echo site_url('administrator/data_formulir/load_isi_diploma'); ?>?grid=true" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" collapsible="true">
	<thead>
		<tr>
