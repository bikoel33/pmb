<div style="width:200px;height:auto;background:#dfedf7;padding:5px;">    
    <div class="easyui-panel" title="Master" collapsible="true" style="width:200px;height:auto;padding:10px;" data-options="iconCls:'icon-master'">  
        ...
        <ul class="easyui-tree">
            ...
            <li data-options="iconCls:'icon-pesan'">
                <a href="<?php echo base_url();?>index.php/administrator/jenjang_akademik">Jenjang Akademik</a>
            </li>
        </ul>
        </div>  
    </div>  
    	...
    	<div data-options="iconCls:'icon-search'" style="padding:0px;">
            <ul class="easyui-tree">
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/data_beli">Data User PMB</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/generate">Generate Kelulusan</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_diploma">Calon Mahasiswa DIII</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_sarjana">Calon Mahasiswa SI</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_magister">Calon Mahasiswa S2</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/data_formulir/view_doktor">Calon Mahasiswa S3</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/pembayaran1">Pembayaran Gel. 1</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/pembayaran2">Pembayaran Gel. 2</a>
                </li>
                <li data-options="iconCls:'icon-surat_perintah'">
                    <a href="<?php echo base_url();?>index.php/administrator/pembayaran">Pembayaran Gel. 3</a>
                </li>
                <!-- <li data-options="iconCls:'icon-surat_perintah'">
    ...
    <div class="easyui-panel" title="Grafik" collapsible="true" style="width:200px;height:auto;padding:10px;" data-options="iconCls:'icon-grafik'">  
        ...
        <ul class="easyui-tree">
            <li data-options="iconCls:'icon-surat_perintah'">
            <a href="<?php echo base_url();?>index.php/administrator/grafik/grafik_survey">Grafik Survey</a>
            </li>
            <li data-options="iconCls:'icon-surat_perintah'">
