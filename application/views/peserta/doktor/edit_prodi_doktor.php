	...
	$("#simpan").click(function(){
		...
		*/
		if (confirm('Pilihan Jurusan tidak dapat diulang, apakah yakin akan menyimpannya ?')){
			...
			$.ajax({
				type	: 'POST',
				url		: "<//?php echo site_url(); ?>/peserta/home/simpan_edit_prodi_doktor",
				data	: string,
				cache	: false,
				dataType   : 'json',
				success	: function(data){
					if(data.status != 'error'){
						window.location.assign("<//?php echo site_url();?>/peserta/home/edit_survey_doktor");
					}
					alert(data.msg);
				}
			});
	...
	<table class="table table-bordered table-striped table-hover">
		<tbody>
			...
			<tr>
				<td colspan="2">
					<center>
						<a href="<?php echo base_url();?>index.php/peserta/home/edit_surat_pernyataan_doktor" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
						...
						<a href="<?php echo base_url();?>index.php/peserta/home/edit_survey_doktor" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a>
					</center>
				</td>
			</tr>
		</tbody>
