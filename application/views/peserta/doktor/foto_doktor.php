      ...
      $.ajaxFileUpload({
         ...
         success  : function (data,status){
			if(data.status != 'error'){
			   window.location.assign("<?php echo site_url();?>/peserta/home/ktp_doktor");
            }
            alert(data.msg);
         }
      });
...
<tr>
    ...
    <a href="<?php echo base_url();?>index.php/peserta/home/ktp_doktor" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a>
    </center>
</tbody>
</table>
</form>
