...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/peserta/home/simpan_survey_doktor",
			data	: string,
			cache	: false,
			success	: function(data){
				window.location.assign("<?php echo site_url();?>/peserta/home/selesai_doktor")
			}
		});
...
<tr>
	<td colspan="2">
	<center>
		<a href="<?php echo base_url();?>index.php/peserta/home/edit_prodi_doktor" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
		...
		<a href="<?php echo base_url();?>index.php/peserta/home/doktor" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan Dan Selesai</a>
    </center>
</tbody>
</table>
</form>