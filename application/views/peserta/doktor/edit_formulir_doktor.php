...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/peserta/home/simpan_edit_formulir_doktor",  // load controller
			data	: string,
			cache	: false,
			dataType  : 'json',
			success	: function(data){
				if(data.status != 'error'){
			   		window.location.assign("<?php echo site_url();?>/peserta/home/edit_foto_doktor")  // load controller
            	}
            	alert(data.msg);
			}
		});
...
<tr>
	<td colspan="2">
		<center>
			...
			<a href="<?php echo base_url();?>index.php/peserta/home/doktor" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
			...
			<a href="<?php echo base_url();?>index.php/peserta/home/edit_foto_doktor" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a>
		</center>
	</td>
</tbody>
</table>
