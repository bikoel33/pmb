	...
	$('#my-form').submit(function(e) {
      ...
      $.ajaxFileUpload({
         ...
         success  : function (data,status){
            ...
            window.location.assign("<?php echo site_url();?>/peserta/home/skhun_diploma");
...
<tr>
	<td colspan="2"><center>
    <a href="<?php echo base_url();?>index.php/peserta/home/kk_diploma" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
    <button type="submit" name="simpan" id="simpan" class="btn btn-primary"><i class="icon-hand-right icon-white"></i> Selanjutnya</button>
    <!--a href="<?php echo base_url();?>index.php/peserta/home/skhun_diploma" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a-->
    </center>
</tbody>
</table>
</form>
