...
<!-- <//?php if($status_bayar == "") {?>			
<tr>
	<td colspan="2"><strong><font style="color: red">SILAHKAN MELAKUKAN PEMBAYARAN DAN UPLOAD SLIP BUKTI PEMBAYARAN PADA MENU PEMBAYARAN YANG ADA DISAMPING KIRI</font></strong></td>
</tr>
<//?php } ?> -->
	...
	<td colspan="2">
		<center>
			...
			<?php if($status_bayar == "LUNAS") {?>
				<a href="<?php echo base_url();?>index.php/peserta/home/cetak_diploma" class="btn btn-success"><i class="icon-print icon-white"></i> Download Kartu Ujian</a>
			<?php } ?>
			
			<?php if($status_bayar == "") {?>
				<a href="<?php echo base_url();?>index.php/peserta/home/edit_formulir_diploma" class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a>
			<?php } ?>
