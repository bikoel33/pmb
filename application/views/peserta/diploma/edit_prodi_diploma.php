	...
	$("#simpan").click(function(){
		...
		*/
		if (confirm('Pilihan Jurusan tidak dapat diulang, apakah yakin akan menyimpannya ?')){
			...
			$.ajax({
				type	: 'POST',
				url		: "<//?php echo site_url(); ?>/peserta/home/simpan_edit_prodi_diploma",
				data	: string,
				cache	: false,
				dataType   : 'json',
				success	: function(data){
					if(data.status != 'error'){
						window.location.assign("<//?php echo site_url();?>/peserta/home/edit_survey_diploma");
					}
					alert(data.msg);
				}
			});
			...
			<tr>
				<td colspan="2">
					<center>
						...
						<a href="<?php echo base_url();?>index.php/peserta/home/edit_survey_diploma" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a>
					</center>
				</td>
			</tr>
		</tbody>
