...
$(document).ready(function(){
	...
	$('#my-form').submit(function(e) {
      ...
      if(data.status != 'error' && data.jalur == "prestasi"){
         window.location.assign("<?php echo site_url();?>/peserta/home/edit_nilai_rapot_diploma");
...
<tr>
	<td colspan="2"><center>
    <a href="<?php echo base_url();?>index.php/peserta/home/edit_ijazah_diploma" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
    ...
    <!--a href="<?php echo base_url();?>index.php/peserta/home/edit_nilai_rapot_diploma" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a--> <?php }else if($this->session->userdata('jalur') == "mandiri"){?>
    <!--a href="<?php echo base_url();?>index.php/peserta/home/edit_prodi_diploma" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a--><?php } ?>
    </center>
</tbody>
</table>
</form>
