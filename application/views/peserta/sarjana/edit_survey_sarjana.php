...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/peserta/home/simpan_survey_sarjana",
			data	: string,
			cache	: false,
			dataType   : 'json',
			success	: function(data){
				if(data.status != 'error'){
            			window.location.assign("<?php echo site_url();?>/peserta/home/selesai_sarjana")
          			}
          			alert(data.msg);
			}
		});
...
<tr>
	...
	<center>
		...
		<a href="<?php echo base_url();?>index.php/peserta/home/sarjana" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan Dan Selesai</a>
    </center>
</tbody>
</table>
</form>