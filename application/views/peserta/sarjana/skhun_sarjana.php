      ...
      $.ajaxFileUpload({
         ...
         success  : function (data,status,jalur){
			if(data.status != 'error' && data.jalur == "prestasi"){
			   window.location.assign("<?php echo site_url();?>/peserta/home/nilai_rapot_sarjana");
            }else if(data.status != 'error' && data.jalur != "prestasi"){
                  window.location.assign("<?php echo site_url();?>/peserta/home/survey_sarjana")
            }
            alert(data.msg);
         }
      });
...
<tr>
	<td colspan="2"><center>
    <a href="<?php echo base_url();?>index.php/peserta/home/ijazah_sarjana" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
    ...
    <!--a href="<?php echo base_url();?>index.php/peserta/home/nilai_rapot_sarjana" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a--> <?php }else{?>
    <!--a href="<?php echo base_url();?>index.php/peserta/home/prodi_sarjana" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan</a--><?php } ?>
    </center>
</tbody>
</table>
</form>
