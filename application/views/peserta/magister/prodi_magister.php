...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		if (confirm('Pilihan Jurusan tidak dapat diulang, apakah yakin akan menyimpannya ?')){
			...
			$.ajax({
				type	: 'POST',
				url		: "<//?php echo site_url(); ?>/peserta/home/simpan_prodi_magister",
				data	: string,
				cache	: false,
				dataType   : 'json',
				success	: function(data){
					if(data.status != 'error'){
						window.location.assign("<//?php echo site_url();?>/peserta/home/survey_magister")
					}
					alert(data.msg);
				}
			});
...
<form id="my-form" name="my-form" method="POST" action="#">
	<table class="table table-bordered table-striped table-hover">
		<tbody>
			...
			<tr>
				<td colspan="2"><center>
				<a href="<?php echo base_url();?>index.php/peserta/home/surat_pernyataan_magister" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
