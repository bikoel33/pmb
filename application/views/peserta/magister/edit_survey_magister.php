...
$(document).ready(function() {
	...
	$("#simpan").click(function(){
		...
		$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>/peserta/home/simpan_survey_magister",
			data	: string,
			cache	: false,
			success	: function(data){
				window.location.assign("<?php echo site_url();?>/peserta/home/selesai_magister")
			}
		});
...
<tr>
	<td class="span4">Survey yang telah anda jawab </td>
	<td><strong><?php echo $this->app_model->CariSurvey($this->session->userdata('nik'));?></strong></td>
</tr>     
<tr>
...
<tr>	
    ...
    <li><input type="checkbox" class="cek" name="cek4" value="Mahasiswa Unusia," />Mahasiswa Unusia</li>
...
<tr>
	<td colspan="2">
	<center>
		<a href="<?php echo base_url();?>index.php/peserta/home/edit_prodi_magister" class="btn btn-info"><i class="icon-hand-left icon-white"></i> Kembali</a>
    	<button type="button" name="simpan" id="simpan" class="btn btn-success" onclick="return();"><i class="icon-hand-right icon-white"></i> Selesai</button>
		<a href="<?php echo base_url();?>index.php/peserta/home/magister" class="btn btn-danger"><i class="icon-thumbs-up icon-white"></i> Abaikan Dan Selesai</a>
    </center>
</tbody>
</table>
</form>