	...
	<td colspan="2">
		<center>
			...
			<?php if($status_bayar == "LUNAS") {?>
				<a href="<?php echo base_url();?>index.php/peserta/home/cetak_magister" class="btn btn-success"><i class="icon-print icon-white"></i> Download Kartu Ujian</a>
			<?php } ?>
			
			<?php if($status_bayar == "") {?>
				<a href="<?php echo base_url();?>index.php/peserta/home/edit_formulir_magister" class="btn btn-info"><i class="icon-pencil icon-white"></i> Edit</a>
			<?php } ?>			
