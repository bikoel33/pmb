                    ...
                    <tr align="center">
                        ...
                        <td width="30%">
                            <div class="progress progress-striped active">
                                ...
                                <div class="bar bar-danger" style="width: 50%;">03 Juli - 25 Agustus 2019</div>
                            </div>
                        </td>
                        <td width="2%">&nbsp;</td>
                    </tr>
            ...
            <div class="span12 bs-docs-sidenav-header">
                <table align="center" border="0" width="100%">
                    <tr align="center">
                        ...
                        <td width="30%">
                            <div class="progress progress-striped active">
                                <div class="bar bar-success" style="width:50%;">Gelombang I S2/S3</div>
                                <div class="bar bar-danger" style="width: 50%;">20 Maret- 20 Juni 2019</div>
                            </div>
                        </td>
                        <td width="2%">&nbsp;</td>
                        <td width="30%">
                            <div class="progress progress-striped active">
                                <div class="bar bar-success"" style="width: 50%;">Gelombang II S2/S3</div>
                                <div class="bar bar-danger" style="width: 50%;">24 Juni - 31 Austus 2019</div>
                            </div>
                        </td>
                        <td width="2%">&nbsp;</td>
                        <td width="2%">&nbsp;</td>
            ...
            <div class="row"> 
                ...
                <div class="span3 kotak">
                    ...
                    <ul class="nav nav-list bs-docs-sidenav">
                        ...
                        <li><a href="<?php echo base_url();?>index.php/home/visimisi"><i class="icon-road"></i> <i class="icon-chevron-right"></i> Visi Misi</a></li>
